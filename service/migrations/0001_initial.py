# Generated by Django 4.0.4 on 2022-10-26 00:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentation', models.FileField(
                    blank=True, upload_to='documentation/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Pressure', 'Pressure'), ('Tempreture', 'Tempreture'), ('Distance', 'Distance'), ('Humidity', 'Humidity'), (
                    'Proximity', 'Proximity'), ('Gyroscope', 'Gyroscope'), ('Optical', 'Optical'), ('Accelerometer', 'Accelerometer')], max_length=200, null=True)),
                ...
                ('system', models.ForeignKey(
                    on_delete=django.db.models.deletion.DO_NOTHING, to='service.system')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor', models.ForeignKey(
                    on_delete=django.db.models.deletion.DO_NOTHING, to='service.sensor')),
            ],
        ),
    ]
